            		...
            		<table class="table table-striped table-sm">
            			...
            			<tbody>
            				<tr>
            					...
            					<td>
            						<a class="btn btn-info btn-ok" href="<?php echo $base_file ?>?update=<?=$row['id'] ?>"><i class="fa-solid fa-pen"></i></a>
            						&nbsp;&nbsp;&nbsp;
            						<a class="btn btn-danger btn-ok" href="#" data-href="<?php echo $base_file ?>?delete=<?=$row['id'] ?>" data-toggle="modal" data-target="#confirm-delete"><i class="fa-solid fa-trash"></i></a>
            					</td>
            				</tr>
            			</tbody>
            			<?php }?>
